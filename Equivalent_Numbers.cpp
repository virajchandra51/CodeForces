...
void solve()
{
    ...
    if(f==1 && in==1)
    {
        ...
        for(auto it:af)
        {
            factor = bf[it.f]*1.0/it.s;
            break;
        }
        for(auto it:af)
        {
            if(bf[it.f]*1.0/it.s!=factor)
            {
                f2=0;break;
            }
        }
    ...
    else if(f==1 && in==0)
    {
        ...
        for(auto it:af)
        {
            factor = it.s*1.0/bf[it.f];
            break;
        }
        for(auto it:af)
        {
            if(it.s*1.0/bf[it.f]!=factor)
            {
                f2=0;break;
            }
        }
