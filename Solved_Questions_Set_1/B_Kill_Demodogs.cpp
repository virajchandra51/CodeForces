...
void solve()
{
    ...
    ll ans1 = n;
    ans1 = ((ans1%M)*((n+1)%M)%M);
    ans1 = ((ans1%M)*((2*n+1)%M)%M);
    ans1 = ((ans1%M)*((powermod(6,M-2,M))%M)%M);
    ans1 %= M;
    n--;

    ll ans2 = n;
    ans2 = ((ans2%M)*((n+1)%M)%M);
    ans2 = ((ans2%M)*((2*n+1)%M)%M);
    ans2 = ((ans2%M)*((powermod(6,M-2,M))%M)%M);
    ans2 %= M;

    ll ans3 = n;
    ans3 = ((ans3%M)*((n+1)%M)%M);
    ans3 = ((ans3%M)*((powermod(2,M-2,M))%M)%M);

    ll ans4 = (ans1%M+ans2%M+ans3%M)%M;
    ans4 = ((ans4%M)*((2022)%M)%M);
    cout<<ans4<<endl;
}
