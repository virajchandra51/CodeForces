...
void solve()
{
    ...
    rep(i,q)
    {
        int k,l1,r1,l2,r2;
        cin>>k>>l1>>r1>>l2>>r2;
        int firstone = dp[r1][k]-dp[l1-1][k];
        int secondone = dp[r2][k]-dp[l2-1][k];
        int firstzero = (r1-l1+1)-firstone;
        int secondzero = (r2-l2+1)-secondone;
        ll ans = (firstone*secondzero);
        ans+=(firstzero*secondone);
        cout<<ans<<endl;
    }
}
